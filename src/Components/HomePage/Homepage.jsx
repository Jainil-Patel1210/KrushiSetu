...
function Homepage() {
    ...
    return (
        <>
            <Navbar />
            <div id="home" className="middle-bg w-full">
                <div className="w-full bg_green_layer bg-[#1B7A43] flex justify-around p-1">
                    <div className="flex flex-col text-center text-white mt-40 space-y-3 md:ml-5 md:text-left">
                        ...
                        <button onClick={() => navigate('/learn-more')} className='bg-white p-1 rounded-md pl-3 pr-3 text-green-600 mt-5 w-30 font-bold mx-auto md:mx-0 hover:bg-gray-100 transition-colors cursor-pointer'>Learn More</button>
                    </div>
